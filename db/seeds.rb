...
photo29 = Photo.create(name: "Ludmila between bars", context: "Femmes de Gueule", date: Date.today, photo_url: "http://res.cloudinary.com/stephwithunaccentaigu/image/upload/v1509698725/Femmes%20de%20Gueule/ThierryLudmila.pdf", album: album1)
photo30 = Photo.create(name: "Ludmila orange", context: "Femmes de Gueule", date: Date.today, photo_url: "http://res.cloudinary.com/stephwithunaccentaigu/image/upload/v1509698707/Femmes%20de%20Gueule/Ludmila.pdf", album: album1 )
photo31 = Photo.create(name: "Ludmila close-up", context: "Femmes de Gueule", date: Date.today, photo_url: "http://res.cloudinary.com/stephwithunaccentaigu/image/upload/v1509698693/Femmes%20de%20Gueule/LudmilaNatural.pdf", album: album1 )
